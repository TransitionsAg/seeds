...
export const buttonVariants: (props?: {
  ...
  base: "inline-flex items-center justify-center rounded font-semibold transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  variants: {
    intent: {
      primary:
...
export type ButtonProps<T extends ValidComponent = "button"> = VariantProps<typeof buttonVariants> &
