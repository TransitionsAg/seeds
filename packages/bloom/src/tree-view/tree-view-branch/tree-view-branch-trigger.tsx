...
type BranchTriggerProps = Parameters<typeof TreeViewPrimitive.Branch.Trigger>[0];

export function TreeViewBranchTrigger(rawProps: BranchTriggerProps): JSX.Element {
