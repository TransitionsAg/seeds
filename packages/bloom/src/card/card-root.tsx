...
export const cardVariants: (props?: { size?: "normal" | "sm" | "fit"; class?: string }) => string =
  cva({
...
type CardRootProps<T extends ValidComponent = "div"> = VariantProps<typeof cardVariants> &
  PolymorphicProps<T>;
