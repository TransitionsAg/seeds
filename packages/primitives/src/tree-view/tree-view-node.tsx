import { type ComponentProps, type JSX, mergeProps, type ValidComponent } from "solid-js";
...
export function TreeViewNodeCheckbox<T extends ValidComponent = "div">(
  ...
  return (
    <Polymorphic {...mergeProps({ as: "div" as T }, api().getNodeCheckboxProps(node), rawProps)} />
  );
}
